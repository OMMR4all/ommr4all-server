"""
Django settings for gregorian_annotator_server project.
...
ROOT_URLCONF = 'gregorian_annotator_server.urls'
...
WSGI_APPLICATION = 'gregorian_annotator_server.wsgi.application'
