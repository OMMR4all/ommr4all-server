...
class TestClef(unittest.TestCase):
    ...
    def test_name_octave(self):
        ...
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.LINE_1), (NoteName.B, 2))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.SPACE_2), (NoteName.C, 3))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.LINE_2), (NoteName.D, 3))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.SPACE_3), (NoteName.E, 3))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.LINE_3), (NoteName.F, 3))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.SPACE_4), (NoteName.G, 3))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.LINE_4), (NoteName.A, 3))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.SPACE_5), (NoteName.B, 3))

        clef = create_clef(clef_type=ClefType.F, position_in_staff=MusicSymbolPositionInStaff.LINE_4)
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.LINE_1), (NoteName.G, 2))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.SPACE_2), (NoteName.A, 2))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.LINE_2), (NoteName.B, 2))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.SPACE_3), (NoteName.C, 3))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.LINE_3), (NoteName.D, 3))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.SPACE_4), (NoteName.E, 3))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.LINE_4), (NoteName.F, 3))
        self.assertTupleEqual(clef.note_name_octave(MusicSymbolPositionInStaff.SPACE_5), (NoteName.G, 3))
