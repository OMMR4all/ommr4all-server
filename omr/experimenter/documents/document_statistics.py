...
workbook = openpyxl.load_workbook('/tmp/Geesebook1_base_predict_full.xlsx')
sheet = workbook.get_sheet_by_name("Symbols Docs")
...
integrate_and_algin_sheet_in_workbook(sheet, 6, sheet2, documents)
...
"""
workbook.save("/tmp/Geesebook1_base_predict_full_stats.xlsx")