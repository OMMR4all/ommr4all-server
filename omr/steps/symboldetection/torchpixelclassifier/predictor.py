...
class PCTorchPredictor(SymbolsPredictor):
    ...
    def __init__(self, settings: AlgorithmPredictorSettings):
        ...
        settings = PredictorSettings(
            ...
            MODEL_PATH=os.path.join(settings.model.local_file('model.torch')),
        )
        self.predictor = Network(settings)
    ...
    def _predict(self, pcgts_files: List[PcGts], callback: Optional[PredictionCallback] = None) -> Generator[
        ...
        for index, row in df.iterrows():
            ...
            symbols = SingleLinePredictionResult(self.extract_symbols(output, labels, m, dataset),
                                                 data)
